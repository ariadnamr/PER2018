...
def process_client(clientsocket):
    ...
    mensaje_solicitud = clientsocket.recv(1024).decode("utf-8") # Lee 1024 caracteres de lo que me manda el navegador por ese socket
    print(mensaje_solicitud)

    lista = mensaje_solicitud.split(" ")

    if lista[1] == "/" or lista[1] == "/index":
        FILE_HTML = "index.html"
    elif lista[1] =="/blue":
        FILE_HTML = "blue.html"
    else:
    ...
    mensaje_respuesta = str.encode(linea_inicial + cabecera + "\n" + contenido) #Este es el mensaje que se envia(en la linea siguiente), antes solo la hemos ido creando
